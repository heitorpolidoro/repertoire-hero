...
> **Task ID Naming Format (`id`)**: ALWAYS use the `RH-N` format (e.g. `RH-1`, `RH-14`), incrementing sequentially for each new task. NEVER use random IDs, slugs, or arbitrary string names.
