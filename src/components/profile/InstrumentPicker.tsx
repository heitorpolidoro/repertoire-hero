      ...
      {INSTRUMENT_LIST.map((instrument) => {
        ...
        return (
          <button
            ...
            className={`flex items-center gap-1 px-3 py-1.5 rounded-full text-sm border transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
              isSelected
            ...
            {isSelected && (
              ...
              >
                {isPrimary ? (
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 text-indigo-300 hover:text-yellow-300 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
